...
const Blog = () => {
    return (
        <div>
            ...
            <div className='bg-gradient-to-r from-red-800 via-blue-600 to-green-600 mt-5 text-lg text-white p-5 w-11/12 m-auto rounded-tl-3xl rounded-br-3xl'>
            ...
            <div className='bg-gradient-to-r from-blue-800 via-green-600 to-orange-600 mt-5 text-lg text-white p-5 w-11/12 m-auto rounded-tl-3xl rounded-br-3xl'>
            ...
            <div className='bg-gradient-to-r from-violet-800 via-indigo-600 to-green-600 mt-5 text-lg text-white p-5 w-11/12 m-auto rounded-tl-3xl rounded-br-3xl'>
